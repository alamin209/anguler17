...
@Component({
  selector: "app-member-video-form",
  templateUrl: "./video-form.component.html",
  styleUrls: ["./video-form.component.sass","../../../../assets/css/memberpage.css"],
})
export class VideoFormComponent implements OnInit {
    ...
    this.VideoService.getVideoDetailsSingle(cond).subscribe(res => {
      if (res && res.data && res.data.length) {
        ...
        if(res.data[0].Video_Thumbnail_Large != ''){
          if(res.data[0].Video_Source == 'youtube'){
            this.imageURL = 'https://'+res.data[0].Video_Thumbnail_Large;
          }else{
  ...
  onSubmit(videoData) {
    ...
    if (this.videoForm.valid) {
      ...
      videoData['ID'] = this.videoSingle.ID;
      ...
      videoData["oldVideo"] = this.videoSingle.Video_Url;
      videoData["oldImage"] = this.videoSingle.Video_Thumbnail_Large;
      ...
      if(this.videoSingle.Video_Source == 'Uploaded'){
        this.VideoService.updateVideo(videoData).subscribe((res) => {
