...
@Component({
  ...
  styleUrls: ["./resources-form.component.sass","../../../../assets/css/memberpage.css"],
})
...
export class ResourcesFormComponent implements OnInit {
  ...
  onSubmit(resourceData) {
    ...
    if (this.resourceForm.valid) {
      ...
      resourceData['userName'] = this.userData.first_name+' '+this.userData.last_name;
      ...
      resourceData["categoryName"] = '';
      this.categoryList.map(function(v){
        if(v.ID = resourceData.selCategory){
          resourceData["categoryName"] = v.name;
        }
      });
        ...
        (res) => {
          ...
          this.translate
            ...
            .subscribe((res: string) => {
              ...
              this.changeRouter('member/products?type=Resources');
