...
@Component({
  selector: "app-marketplace-mobile-filter",
  templateUrl: "./marketplace-mobile-filter.component.html",
  styleUrls: ["./marketplace-mobile-filter.component.sass"],
})
export class MarketplaceMobileFilterComponent implements OnInit {
